	...
	<div class="container">
		...
		<div class="one-third column">
			<div class="icon-box rounded alt">
				...
				<p>Pada halaman portal ini kami memberikan informasi terkait lowongan pekerjaan yang ada pada Ibnu Hajar Boarding School</p>
			</div>
		</div>
		...
		<div class="one-third column">
			<div class="icon-box rounded alt">
				...
				<h4>Pencarian Dilanjutkan</h4>
				<p>Informasi terkait lowongan pekerjaan di IHBS akan dilanjutkan untuk pencarian kadidat yang sesuai dengan kriteria dan kebutuhan kami.</p>
			</div>
		</div>
		...
		<div class="one-third column">
			<div class="icon-box rounded alt">
				...
				<h4>Penerimaan Kandidat</h4>
				<p>Proses rekruitmen kandidat calon terpilih akan kami terima sesuai dengan aturan dasar yayasan.</p>
			</div>
		</div>
...
<div class="container">
	...
	<div class="padding-right">
		<h3 class="margin-bottom-25">Pekerjaan Terkini</h3>
		...
		<a href="<?php echo site_url('jobs');?>" class="button centered"><i class="fa fa-plus-circle"></i> Tampilkan Lebih Banyak Pekerjaan</a>
	...
	<div class="five columns">
		<h3 class="margin-bottom-5">Pekerjaan Unggulan</h3>
