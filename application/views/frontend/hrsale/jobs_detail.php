			...
			<div class="job-overview">
				...
				<ul>
					...
					<li>
						...
						<div>
							<strong>Maksimal Pengiriman:</strong>
				...
				<div id="small-dialog" class="zoom-anim-dialog mfp-hide apply-popup">
					...
					<div class="small-dialog-content">
                        ...
                        <?php echo form_open('jobs/apply_job/1', $attributes, $hidden);?>
							...
							<!-- Upload CV -->
							<div class="upload-info"><strong>Unggah CV Anda (opsional)</strong> <span>Maksimal ukuran file: 5MB</span></div>
							<div class="clearfix"></div>

							<label class="upload-btn">
							    <input type="file" id="resume" name="resume" />
							    <i class="fa fa-upload"></i> Jelajahi
							</label>
							<div class="divider"></div>

							<button type="submit" class="send">Kirim Lamaran</button>
						</form> 
					</div>
