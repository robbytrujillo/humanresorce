...
<!-- Preloader End -->
<div class="authentication-wrapper authentication-2 ui-bg-cover ui-bg-overlay-container px-4" style="background-image: url('<?php echo base_url();?>skin/hrsale_vendor/assets/img/bg/bg-4.png');">
