...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 20, 2020 at 08:07 AM
...
CREATE TABLE `xin_company_documents` (
  ...
  `license_name` varchar(255) CHARACTER SET latin1 NOT NULL,
  `company_id` int(11) NOT NULL,
  `expiry_date` varchar(255) CHARACTER SET latin1 NOT NULL,
  `license_number` varchar(255) CHARACTER SET latin1 NOT NULL,
  `license_notification` int(11) NOT NULL,
  `added_by` int(11) NOT NULL,
  `document` varchar(255) CHARACTER SET latin1 NOT NULL,
...
(1, 'logo_1594349111.png', 'logo2_1520609223.png', 'signin_logo_1520612279.png', 'favicon_1594349112.png', '', '', 'NAMA PT', '', '', 'Jhon Due', 'demo@google.com', '123456789', 'Address Line 1', 'Address Line 2', 'City', 'State', '11461', 190, '2017-05-20 12:05:53');
...
(1, 'fionagrace', 1, 0, 'Jhon', 'Due', 'superuser', 'demo@gmail.com', 0, '$2y$12$Nc76mfT1BNiFeUJbYgEJyuSghodXTSOviYiIMXHr/qnZtU.Q/xs/i', '2018-03-28', 'Male', 0, 1, 2, 0, 10, 1, 1, '0', 'monthly', 0, 0, '2018-02-01', '', 'Single', '', 1, '1000', '0', '8', '17', '10', '0', '1', '2', '3', '0', '0', '0', 'Test Address', '', '', '', 'profile_1546421723.png', 'profile_background_1519924152.jpg', '', '', '12345678900', '', '', '', '', '', '', '', '', 1, '20-08-2020 15:03:04', '09-08-2019 08:25:59', '::1', 1, 1, 'fixed_layout_hrsale', '', '', '0,1,2', 0, NULL, 0, 0, '2018-02-28 05:30:44'),
...
(1, 'AlRajhi Bank', '9999000', '10000000', '123456789', '00966', 'Riyadh Branch', '23-06-2020 01:23:16');
...
(1, 'false', 'true', 'false', 'breadcrumb-transparent', 'footer-light', '4', 'fadeInDown', 'template_1', 'dashboard_1', 'true', 'login_page_2', 'fa-check-circle-o', '', '', '', 'true', 'false', 'false', 'false', 'basic_form', 1, 'bg-primary', 'bg-blue-grey', 'menu-dark', 'true', 'PERUSAHAN', 't2b', 'true', 'true', '');
...
--
ALTER TABLE `xin_chat_messages`
  MODIFY `message_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
